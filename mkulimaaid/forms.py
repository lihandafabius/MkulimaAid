...
import re
from wtforms import StringField, PasswordField, SubmitField, DecimalField, FileField, BooleanField, TextAreaField, SelectField
...
class FarmersForm(FlaskForm):
    # List of all regions in Kenya for the dropdown
    REGIONS = [
    ...
    location = SelectField('Region', choices=REGIONS, validators=[DataRequired()], render_kw={"class": "form-select"})
